...
paru -S --noconfirm --needed hyprland sddm grim polkit-gnome polkit hypridle dbus qt5-wayland qt6-wayland slurp xdg-desktop-portal-hyprland wl-clipboard noto-fonts swww fcitx5 easyeffects cliphist fzf unzip brightnessctl swappy tokyonight-gtk-theme-git
