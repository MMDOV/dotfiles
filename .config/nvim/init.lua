...
require('lazy').setup({
  ...
  { 'glacambre/firenvim', build = ':call firenvim#install(0)' },
  {
    ...
    event = 'User BaseFile', -- or another event that suits your setup
  },
  {
    'saghen/blink.cmp',
  ...
  --			vim.g.magma_image_provider = "kitty" -- Ensure compatibility with your terminal
  --		end,
  --	},
  {
...
vim.keymap.set('n', '<C-f>', '<cmd>silent !tmux neww /home/mamadv/.local/bin/tmux-sessionizer<CR>')
...
--vim.g.magma_output_window_type = "floating"
--vim.g.magma_automatically_open_output = true
--vim.g.magma_image_provider = "kitty"
--vim.g.magma_wrap_output = true -- Wrap long output for better readability
--vim.g.magma_output_highlight = "Normal:Normal,FloatBorder:Normal" -- Improve floating window

-- Override the background color
--vim.cmd([[highlight Normal guibg=#0F1320]])
-- Override the background color
--vim.api.nvim_set_hl(0, "Normal", { bg = "#0f1320" })
--vim.api.nvim_set_hl(0, "NormalFloat", { bg = "#0f1320" })
--vim.api.nvim_set_hl(0, "SignColumn", { bg = "#0f1320" })
--vim.api.nvim_set_hl(0, "WinSeparator", { bg = "#0f1320" })
--vim.api.nvim_set_hl(0, "StatusLine", { bg = "#0f1320" })
-- The line beneath this is called `modeline`. See `:help modeline`
-- vim: ts=2 sts=2 sw=2 et
